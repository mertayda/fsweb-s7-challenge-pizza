        ...
        <div className="mt-auto w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 lg:pt-20 mx-auto">
          <div className="flex flex-col  gap-3 lg:flex-row  md:justify-between  items-center  mx-auto  md:items-start ">
            ...
            <div className="col-span-1 md:col-span-1 lg:col-span-1">
              <h4 className="font-semibold text-gray-100">Ürünler</h4>
            ...
            <div className="col-span-1 md:col-span-1 lg:col-span-2">
              <h4 className="font-semibold text-gray-100">Bize Ulaşın</h4>
              <form>
                <div className="mt-4 flex flex-col items-center gap-2 sm:flex-row sm:gap-3 text-white rounded-lg p-2">
          ...
          <div className="mt-5 sm:mt-12 grid gap-y-2 sm:gap-y-0 sm:flex sm:justify-between sm:items-center">
            <div className="flex justify-between items-center">
              <p className="text-sm text-gray-400 dark:text-neutral-400">
                © 2024 Teknolojik Lezzetler.
              </p>
            </div>

            <div className="flex space-x-4">
              <p className="text-xl text-white text-center mt-2 font-satisfty mx-3">
                Bizi Takip Edin!
              </p>
              <a
